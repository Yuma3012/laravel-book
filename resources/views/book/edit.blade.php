        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="w-full" action="{{ route('book.update') }}" method="POST">
              ...
              <div class="border-t border-gray-200">
                <dl>
                  ...
                  <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      <div class="col-span-6 sm:col-span-3">
                        <input type="text" name="read_at" id="read_at" value="{{ old('read_at', $book->read_at) }}" autocomplete="given-name" placeholder="例) 2023-01-01" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        @error('read_at')
                        <div class="text-red-600">{{ $message }}</div>
                        @enderror
                      </div>
            ...
            <div class="flex justify-center">
              ...
              <button onclick="submit" class="mt-4 mr-2 shadow bg-orange-500 hover:bg-orange-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">変更</button>
            </div>
